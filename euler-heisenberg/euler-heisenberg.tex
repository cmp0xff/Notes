...
where
\begin{align}
\rfun{\delta^{d+1}}{x-y} \rbr{\nabla^{y^\mu}\rfun{\phi}{y}}
&= \rfun{\delta^{d+1}}{x-y}
\rbr{\partial^{y^\mu}+\mi e \rfun{A^\mu}{y}}\rfun{\phi}{y} \nonumber \\
...
-\cbr{\rbr{\partial_{x^\mu}+\mi e \rfun{A_\mu}{x}}\rfun{\phi}{x}}^* 
\rfun{\delta^{d+1}}{x-y} \nabla^{y^\mu}\rfun{\phi}{y}}
\nonumber \\
...
\nonumber \\
&= \mathcal{N}\cbr{\sfun{\det}{-\mi \rfun{M}{x, y}}}^{-1/2},
\end{align}
where
\begin{align}
\rfun{M}{x, y} \coloneqq \mathcal{M}_y \rfun{\delta^{d+1}}{x-y},\qquad
\mathcal{M}_y \coloneqq -\rbr{\nabla_{y^\mu}}\rbr{\nabla^{y^\mu}}^* - m^2.
\end{align}
