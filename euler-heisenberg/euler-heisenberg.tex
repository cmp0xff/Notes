...
Maxwell lagrangian
\begin{equation}
\sfun{S_\text{Maxwell}}{A_\mu} \coloneqq \int\dif^4 x\,\rbr{
-\frac{1}{4} F^{\mu\nu} F_{\mu\nu} }
\end{equation}

Dirac lagrangian \citep[sec.~11]{weinberg1995}
\begin{equation}
\sfun{S_\text{Dirac}}{\psi, \bar\psi} \coloneqq \int\dif^4 x\,
\cbr{-\bar{\psi} \rbr{\gamma^\mu\partial_\mu + m}\psi}.
\end{equation}

Interacting term
\begin{equation}
S_\text{IMD} \coloneqq \int\dif^4 x\,\rbr{-\bar{\psi}\gamma^\mu\mi e A_\mu\psi}.
\end{equation}


\begin{equation}
\sfun{S_{1/2}}{A_\mu, \psi, \bar\psi} \coloneqq 
S_\text{Maxwell}+S_\text{Dirac} + S_\text{IMD}.
\end{equation}
...
+\int\dif^4 x\,\rbr{j^\mu A_\mu + \bar\eta \psi+\bar\psi \eta}}}
\end{equation}
...
\sfun{\varGamma}{A_\mu}
+\int\dif^4 x \,j^\mu A_\mu}}.
\end{equation}
In other words,
\begin{align}
\cfun{\exp}{\mi\sfun{\varGamma}{A_\mu}} &\equiv \int
\Dif\psi\,\Dif\bar\psi\,\cfun{\exp}{\mi\rbr{S_\text{Dirac}+S_\text{IMD}}}
\nonumber \\
&\equiv \int\Dif\psi\,\Dif\bar\psi\,\cfun{\exp}{\mi\int\dif^4 x
\bar{\psi} \rbr{-\slashed{\partial}-\mi e \slashed{A} - m}\psi}
\nonumber \\
&= \int\Dif\psi\,\Dif\bar\psi\,\cfun{\exp}{\mi\int\dif^4 x\,\dif^4 y\,
...
\rfun{\slashed{A}}{y} - m}\rfun{\delta^4}{x-y}.
\end{equation}
...
where
\begin{align}
\rfun{M_2}{x, y} \coloneqq \mathcal{M}_y \rfun{\delta^4}{x-y},\quad
...
\end{equation}
A Landau-like choice of four-potential \citep{Landau_1930}
\begin{equation}
